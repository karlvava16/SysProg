...
int Guess()
{
	srand(time(0));
	TCHAR str[50];
	wsprintf(str, TEXT("Это число %d?"), rand() % 99 + 1);	// ASCII-код нажатой клавиши
...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT uMessage, WPARAM wParam, LPARAM lParam)
{
	...
	{ 
		...
		if (win)
		{
			wsprintf(str, TEXT("Вы победили"));	// ASCII-код нажатой клавиши
			
		}
		else
		{
			wsprintf(str, TEXT("Компьютер угадал"));	// ASCII-код нажатой клавиши
		}
		MessageBox(0,
			str,
			TEXT("Угадываю..."),
